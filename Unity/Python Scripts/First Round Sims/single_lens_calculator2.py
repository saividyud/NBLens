...
single_lens_magnifications = single_lens.series_calculate(cm_offset='auto', subdivisions=1)

print('=========================================================')

''' Saving class data to file '''
init_time = t.time()
with open('./Unity/Simulations/single_lens_1e11_cusp.pkl', 'wb') as single_lens_file:
