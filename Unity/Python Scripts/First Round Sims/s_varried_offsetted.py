...
ang_width = 0.07680319680319682 # 0.07680319680319682
thickness = 0.059738867403980045 # 0.059738867403980045
y_minus = -0.970576558378381 # -0.970576558378381
y_plus = 1.030315425782361 # 1.030315425782361
num_r = 779536 # 779536
num_theta = 194884 # 194884
...
file_directory = f'./Unity/Simulations/Collection_pmr_0.01/'
...
if args['lenses'] == 'single':
    ...
    file_name = f'triple_1e11_{s2:.2e}_{args["origin"]}.pkl'
