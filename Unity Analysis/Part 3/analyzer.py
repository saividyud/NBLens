if __name__ == '__main__':
    ...
    binary_directory = './Unity/Simulations/Part_3_Binary_Collection'
    single_directory = './Unity/Simulations/Part_3_Single_Collection'

    #%% Reading in attributes from csv file
    single_attributes = pd.read_csv('./Unity Analysis/Part 3/Data Files/part_3_single_attributes.csv')
    binary_attributes = pd.read_csv('./Unity Analysis/Part 3/Data Files/part_3_binary_attributes.csv')
    ...
    with open(f'./Unity Analysis/Part 3/Data Files/analysis_output_{multiplier:.0e}.csv', 'w', newline='') as csvfile:
        ...
        for i, q in enumerate(qs):
            for j, s in enumerate(ss):
                ...
                single_file = f'{single_directory}/single_{q:.0e}_9.00e-01.pkl'
                single_sim = IRSC.caustic_reader(single_file)

                binary_file = f'{binary_directory}/binary_{q:.0e}_{s:.2e}.pkl'
                ...
                output.append([ss_str[j], q, radius, LD_coeff] + fractional_area_above_thresholds.tolist())
