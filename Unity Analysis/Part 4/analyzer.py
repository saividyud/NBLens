if __name__ == '__main__':
    ...
    single_directory = './Unity/Simulations/Part_4_Single_Collection'

    #%% Reading in attributes from csv file
    single_attributes = pd.read_csv('./Unity Analysis/Part 4/Data Files/part_4_single_attributes.csv')
    binary_attributes = pd.read_csv('./Unity Analysis/Part 4/Data Files/part_4_binary_attributes.csv')
    ...
    with open(f'./Unity Analysis/Part 4/Data Files/analysis_output_{multiplier:.0e}.csv', 'w', newline='') as csvfile:
        ...
        for i, q in enumerate(qs):
            for j, s in enumerate(ss):
                ...
                single_file = f'{single_directory}/single_1e-03_9.00e-01.pkl'
